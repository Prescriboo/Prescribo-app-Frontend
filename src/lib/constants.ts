...
export const DEMO_PRESCRIPTIONS: Prescription[] = [
  { id: 1, patientId: 1, patientName: 'Rajesh Kumar', date: '2026-05-24', diagnosis: 'Upper Respiratory Tract Infection', medicines: ['Amoxicillin 500mg', 'Paracetamol 650mg', 'Cetirizine 10mg'], doctor: 'Dr. David Smith' },
  { id: 2, patientId: 2, patientName: 'Priya Sharma', date: '2026-05-23', diagnosis: 'Type 2 Diabetes Follow-up', medicines: ['Metformin 500mg', 'Atorvastatin 10mg'], doctor: 'Dr. David Smith' },
  { id: 3, patientId: 3, patientName: 'Amit Patel', date: '2026-05-22', diagnosis: 'Allergic Rhinitis', medicines: ['Cetirizine 10mg', 'Montelukast 10mg'], doctor: 'Dr. David Smith' },
  { id: 4, patientId: 4, patientName: 'Sunita Devi', date: '2026-05-21', diagnosis: 'GERD', medicines: ['Omeprazole 20mg', 'Domperidone 10mg'], doctor: 'Dr. David Smith' },
  { id: 5, patientId: 1, patientName: 'Rajesh Kumar', date: '2026-05-15', diagnosis: 'Hypertension Follow-up', medicines: ['Amlodipine 5mg', 'Losartan 50mg'], doctor: 'Dr. David Smith' },
  { id: 6, patientId: 6, patientName: 'Anita Rao', date: '2026-05-20', diagnosis: 'Migraine', medicines: ['Sumatriptan 50mg', 'Prochlorperazine 5mg'], doctor: 'Dr. David Smith' },
]
